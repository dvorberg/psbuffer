...
if __name__ == "__main__":
    ...
    print(join80(b"Lorem ipsum dolor sit amet, consetetur sadipscing elitr, "
                 ...
                 b"gubergren, no sea takimata sanctus est Lorem ipsum dolor sit "
                 b"amet. Lorem ipsum dolor sit amet, consetetur sadipscing "
                 b"elitr, sed diam nonumy eirmod tempor invidunt ut labore et "
                 b"dolore magna aliquyam erat, sed diam voluptua. At vero eos "
                 b"et accusam et justo duo dolores et ea rebum. Stet clita kasd "
                 b"gubergren, no sea takimata sanctus est Lorem ipsum dolor sit "
                 b"amet.".split(b" ")).decode("latin1"))
    print()

...
"""
Print the full name of a font into an EPS file and embed the font in
it. You'll need to supply an outline and a metrics file on the command
line. The resulting ps will be written to stdout.
"""
...
def main():
    ...
    text = unicode(font.full_name) + u" € üäöÜÄÖß"
